...
<body>
        ...
        <div class="header--main">
                <div class="header--content">
                    ...
                    <div class="header--info">
                        <a href="post.php"><img width = "25" src="../assets/img/icon/paper-plane.png" alt=""></a>
                    </div>
                </div>
        </div>
        <div class="nav--main">
    ...
    <main class="dice--container">
        ...
        <a href="people.php"><img width="32" style="filter: invert(1); margin: 10px" src="../assets/img/icon/user.png" alt=""></a>
    </main>
</body>
</html>