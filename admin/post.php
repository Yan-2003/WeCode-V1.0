    ...
    <header class="header--box">
        <div class="header--main">
                ...
                <div class="header--info">
                    <a href="home.php"><img width = "25" src="../assets/img/icon/logo.png" alt=""></a>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="post--main">
            <form action="" method="post" autocomplete="off" class="post--form--content">
                ...
                <div class="category--icon">
                    <label for="spades">
                        <input type="radio" name="category" value="spades" class="spades">
                        <img  width = "45" src="../assets/img/icon/symbol-of-spades.png" alt="">
                    </label>
                    <label for="clover">
                        <input type="radio" name="category" value="clover" class="clover">
                        <img width = "45" src="../assets/img/icon/clover.png" alt="">
                    </label>
                    <label for="diamond">
                        <input type="radio" name="category" value="diamond" class="diamond">
                        <img width = "45" src="../assets/img/icon/diamond.png" alt="">
                    </label>
                    <label for="heart">
                        <input type="radio" name="category" value="hearts" class="hearts">
